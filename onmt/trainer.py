    ...
    def validate(self, valid_iter, moving_average=None):
        ...
        with torch.no_grad():
            ...
            for batch in valid_iter:
                ...
                outputs, attns, self_attentions = valid_model(batch, ques, ques_scores, ans, tgt, ques_lengths, par_arc_lengths,
                                             ans_lengths, with_align=self.with_align)

                # Compute loss.
                _, batch_stats = self.valid_loss(batch, outputs, attns, self_attentions)
        ...
        for k, batch in enumerate(true_batches):
            ...
            for j in range(0, target_size-1, trunc_size):
                ...
                for sent in zip(tgt.permute(1,0,2).squeeze(-1)):
                    ...
                    print('^^^^^^^^^^^^^^^^^^')
                """
                outputs, attns, self_attentions = self.model(batch, ques, ques_scores, ans, tgt, ques_lengths, par_arc_lengths, ans_lengths,
