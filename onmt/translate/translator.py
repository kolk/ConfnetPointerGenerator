...
class Translator(object):
    ...
    def _run_encoder(self, batch):
        ...
        ques_states, ques_memory_bank, ques_lengths, self_attention = self.model.ques_encoder(
        ...
        return src, enc_states, memory_bank, src_lengths, self_attention
    ...
    def _translate_batch_with_strategy(
        ...
        src, enc_states, memory_bank, src_lengths, self_attention = self._run_encoder(batch)
        self.model.decoder.init_state(src, memory_bank, enc_states)
